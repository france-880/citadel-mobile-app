...
class UserModel {
  ...
  final bool hasFacialRecognition; // for students
  ...
  factory UserModel.fromJson(Map<String, dynamic> json) {
    return UserModel(
      ...
      hasFacialRecognition: json['has_facial_recognition'] == true || json['has_facial_recognition'] == 1,
    );
  }
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'dob': dob,
      'photo_url': photoUrl,
      'has_facial_recognition': hasFacialRecognition,
    };
  }
